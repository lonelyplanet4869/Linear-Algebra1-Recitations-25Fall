...
---
# 第二章 矩阵
- 秩零化度定理：$\operatorname{nullity}A(\dim S)+\operatorname{rank}A=\dim(\operatorname{ker}(\varphi_A))+\dim(\operatorname{im}(\varphi_A))=n$，其中 $n$ 为 $A$ 的列数（即未知元的数量）
